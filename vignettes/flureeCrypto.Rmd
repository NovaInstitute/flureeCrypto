...
updated automatically using `devtools::document()` this will not yet allow
full functionality of the C functions. 
The following line has to be added manually to "NAMESPACE".
```
